...
const Arrivalhome = ({arrivalproducts}) => {
        ...
        {arrivalproducts.map((product, i) => (
          <div key={product._id} className=" p-4">
            <div className="flex justify-center items-center">
               <Link href={`/Arrivalproducts/${product._id}`} >
            ...
            <div className="grid grid-cols-2 gap-6 md:gap-2 mt-5 ">
              ...
              <Link href={`/Arrivalproducts/${product._id}`}  className="text-[#F26E21] bg-[#FEF0E8] border border-[#F9BC98] rounded py-3 px-1 font-semibold md:text-sm lg:text-lg  text-base text-center " >
              <button
                type="button">
                Buy now
              </button>
