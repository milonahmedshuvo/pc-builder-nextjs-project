        ...
        {topselling.map((product, i) => (
          <div key={product._id} className=" p-4">
            ...
            <div className="grid grid-cols-2 gap-6 md:gap-2 mt-5 ">
              <button
                type="button"
                className="text-[#3197E9] bg-[#EAF4FD] border border-[#A0CEF4] rounded py-3 px-1 font-semibold md:text-sm lg:text-md  text-base "
              >
                ADD TO CART
              </button>
              <button
                type="button"
                className="text-[#F26E21] bg-[#FEF0E8] border border-[#F9BC98] rounded py-3 px-1 font-semibold md:text-sm lg:text-lg  text-base "
              >
                Buy now
              </button>
            </div>
